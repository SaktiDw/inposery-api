...
class TransactionTest extends TestCase
{
    ...
    //     $response = $this->getJson('/api/transactions?filter[store_id]=1&filter[trashed]=with');
    //     $response->assertStatus(200);
    // }
    ...
    //     Sanctum::actingAs($user);
    //     Transaction::find(2)->delete();
    //     $response = $this->getJson('/api/transactions?filter[store_id]=1&filter[trashed]=only');
    //     $response->assertStatus(200);
    // }
    ...
    //     Sanctum::actingAs($user);
    //     Transaction::find(2)->delete();
    //     $response = $this->getJson('/api/transactions?filter[store_id]=1&filter[product.name]=a&filter[trashed]=only');
    //     $response->assertStatus(200);
    // }
    ...
    // }
    public function test_create_transaction_in()
    {
        $user = User::find(1);
        Sanctum::actingAs($user);
    ...
    public function test_create_transaction_out()
    {
        $user = User::find(1);
        Sanctum::actingAs($user);
        $product = Product::find(1);
